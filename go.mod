...
replace (
	github.com/fluxcd/pkg/kustomize => github.com/eugenepaniot/pkg/kustomize v0.1.1-custom.1
	github.com/fluxcd/pkg/ssa => github.com/eugenepaniot/pkg/ssa v0.1.1-custom.1
)
